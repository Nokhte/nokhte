...
/// Author: Sonny Vesali
///
/// This file defines the [AuthStateStore] class, a MobX store that tracks the
/// authentication state boolean from Supabase. The store extends
/// [_AuthStateStoreBase] and interacts with the UI layer through the
/// [GetAuthStateStore].
///
/// The [AuthStateStore] contains an observable [authState] variable that holds
/// a boolean stream indicating the current authentication state. It initializes
/// this stream by calling the [authStateGetterStore] from the
/// [GetAuthStateStore] and converting it into a broadcast stream.
///
