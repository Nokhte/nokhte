...
part 'irl_nokhte_session_notes_inactivity_widgets_coordinator.g.dart';

class IrlNokhteSessionNotesInactivityWidgetsCoordinator = _IrlNokhteSessionNotesInactivityWidgetsCoordinatorBase
    with _$IrlNokhteSessionNotesInactivityWidgetsCoordinator;

abstract class _IrlNokhteSessionNotesInactivityWidgetsCoordinatorBase
    extends BaseWidgetsCoordinator with Store {
  final BeachWavesStore beachWaves;
  final TouchRippleStore touchRipple;
  final BorderGlowStore borderGlow;
  final MirroredTextStore mirroredText;
  _IrlNokhteSessionNotesInactivityWidgetsCoordinatorBase({
