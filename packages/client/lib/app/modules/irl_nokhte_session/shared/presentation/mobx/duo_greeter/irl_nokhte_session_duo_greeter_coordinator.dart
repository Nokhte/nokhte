...
part 'irl_nokhte_session_duo_greeter_coordinator.g.dart';

class IrlNokhteSessionDuoGreeterCoordinator = _IrlNokhteSessionDuoGreeterCoordinatorBase
    with _$IrlNokhteSessionDuoGreeterCoordinator;

abstract class _IrlNokhteSessionDuoGreeterCoordinatorBase
    extends BaseCoordinator with Store {
  final DecidePhoneRole decidePhoneRoleLogic;
  final IrlNokhteSessionDuoGreeterWidgetsCoordinator widgets;
  final TapDetector tap;
  final SessionPresenceCoordinator presence;
  final GetSessionMetadataStore sessionMetadata;
  final GyroscopicCoordinator gyroscopic;

  _IrlNokhteSessionDuoGreeterCoordinatorBase({
