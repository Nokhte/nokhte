...
part of 'get_purpose_session_metadata_store.dart';
...
mixin _$GetPurposeSessionMetadataStore
    on _GetPurposeSessionMetadataStoreBase, Store {
  late final _$timerShouldRunAtom = Atom(
      name: '_GetPurposeSessionMetadataStoreBase.timerShouldRun',
      context: context);
  ...
  late final _$getAsyncAction =
      AsyncAction('_GetPurposeSessionMetadataStoreBase.get', context: context);
