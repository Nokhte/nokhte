...
part of 'update_online_status_store.dart';
...
mixin _$UpdateOnlineStatusStore on _UpdateOnlineStatusStoreBase, Store {
  late final _$isUpdatedAtom =
      Atom(name: '_UpdateOnlineStatusStoreBase.isUpdated', context: context);
