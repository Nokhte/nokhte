...
part 'listen_to_session_metadata_store.g.dart';

class ListenToSessionMetadataStore = _ListenToSessionMetadataStoreBase
    with _$ListenToSessionMetadataStore;

abstract class _ListenToSessionMetadataStoreBase
    extends BaseMobxDBStore<NoParams, Stream<NokhteSessionMetadata>>
    with Store {
  final ListenToSessionMetadata logic;
