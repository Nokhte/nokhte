...
import 'package:nokhte/app/core/widgets/beach_widgets/beach_waves/stack/presentation/mobx/movie_stores/ocean_dive_to_times_up/ocean_dive_to_times_up_movie.dart';
...
abstract class _OceanDiveToTimesUpMovieStoreBase
  ...
  _OceanDiveToTimesUpMovieStoreBase() {
    movie = OceanDiveToTimesUpMovie.getMovie(timerLength: Seconds.get(45));
