...
void main() {
  ...
  setUp(() {
    mockLogic = MockMStartRecording();
    getterStore = StartRecordingGetterStore(logic: mockLogic);
  });

  group("✅ Success Cases", () {
    setUp(() {
      tEitherStatusOrFailure = ConstantRecordingStatusEntity.wrappedSuccessCase;
    });
