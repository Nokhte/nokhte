...
part of 'get_the_purpose_store.dart';
...
mixin _$GetThePurposeStore on _GetThePurposeStoreBase, Store {
  late final _$thePurposeAtom =
      Atom(name: '_GetThePurposeStoreBase.thePurpose', context: context);
  ...
  late final _$futureStoreAtom =
      Atom(name: '_GetThePurposeStoreBase.futureStore', context: context);
  ...
  late final _$callAsyncAction =
      AsyncAction('_GetThePurposeStoreBase.call', context: context);
